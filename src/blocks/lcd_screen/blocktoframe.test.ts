...
describe("lcd  factories", () => {
  ...
  it("LCD Screen simple print should print something simple", () => {
    ...
    const lcdPrintLCDBlock2 = workspace.newBlock(
      "lcd_screen_20x4"
    ) as BlockSvg;
    ...
    const numBlock2 = createValueBlock(workspace, VariableTypes.NUMBER, 3);
    lcdPrintLCDBlock2
      .getInput("ROW_1")
      .connection.connect(textRowBlock1.outputConnection);
    lcdPrintLCDBlock2
    ...
    lcdPrintLCDBlock2
      .getInput("DELAY")
      .connection.connect(numBlock2.outputConnection);

    connectToArduinoBlock(lcdPrintLCDBlock2);
